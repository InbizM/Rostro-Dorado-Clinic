            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="w-full flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        <a href="https://www.instagram.com/rostrodoradoclinic/" target="_blank" rel="noopener noreferrer" className="p-2 hover:text-gold transition-colors hover:scale-110 duration-300" aria-label="Instagram">
                            <Instagram size={20} />
                        </a>
                        <a href="https://www.facebook.com/people/Dra-Isaura-Dorado/100067023886893/" target="_blank" rel="noopener noreferrer" className="p-2 hover:text-gold transition-colors hover:scale-110 duration-300" aria-label="Facebook">
                            <Facebook size={20} />
                        </a>
                        <a href="https://www.tiktok.com/@draisauradorado" target="_blank" rel="noopener noreferrer" className="p-2 hover:text-gold transition-colors hover:scale-110 duration-300" aria-label="TikTok">
                            {/* TikTok Custom SVG */}
