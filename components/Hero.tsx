...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-[110vh] w-full overflow-hidden flex items-center justify-center bg-base">
      ...
      >
        ...
        <img 
          ...
          loading="eager"
          decoding="sync"
          // CLS Optimization: Dimensiones explícitas (el CSS sigue controlando el tamaño visual)
          width="1920"
          height="1080"
        />
      </motion.div>
      ...
      <div className="relative z-20 text-center px-6 max-w-5xl mx-auto mt-20">
        ...
        >
          ...
          <h1 className="font-serif text-5xl md:text-7xl lg:text-9xl text-white leading-none mb-8 drop-shadow-lg mix-blend-overlay opacity-90">
