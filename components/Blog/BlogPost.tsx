        ...
        <div className="bg-white min-h-screen pt-28 pb-20">
            ...
            <article className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="text-center max-w-4xl mx-auto mb-12">
                    ...
                    >
                        <span className="inline-block px-3 py-1 bg-gold/10 text-gold text-xs font-bold tracking-[0.2em] uppercase mb-4 rounded-sm">
                            Medicina Estética
                        </span>
                        ...
                        <div className="flex items-center justify-center gap-6 text-gray-500 font-sans text-sm border-y border-gray-100 py-4 mx-auto w-fit px-8">
                ...
                {/* Main Feature Image - Wide and Dramatic */}
                <motion.div
                    initial={{ opacity: 0, scale: 0.98 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ delay: 0.2 }}
                    className="w-full aspect-[21/9] md:aspect-[2/1] bg-gray-100 rounded-2xl overflow-hidden mb-16 shadow-sm"
                >
                    <img
                        src={post.coverImage}
                        alt={post.title}
